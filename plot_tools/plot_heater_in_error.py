...
def main():
    ...
    comf_temp_path = 'HBrokenComfTempLog.txt'
    comf_aq_path = 'HBrokenComfAirqualityLog.txt'

    eco_temp_path = 'HBrokenEcoTempLog.txt'
    eco_aq_path = 'HBrokenEcoAirqualityLog.txt'
