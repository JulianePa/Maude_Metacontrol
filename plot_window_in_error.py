...
def main():
    ...
    whErr_temp_path = 'WBrokenComfTempLog.txt'
    whErr_aq_path = 'WBrokenComfAirqualityLog.txt'

    wErr_temp_path = 'WBrokenEcoTempLog.txt'
    wErr_aq_path = 'WBrokenEcoAirqualityLog.txt'
    ...
    print('WindowErr number temp violation: ',hHerr_temp_violation[0], ' number AQ violation: ',hHerr_aq_violation[0], ' total number of violation: ', hHerr_temp_violation[0]+hHerr_aq_violation[0])
    print('WindowErr amount temp violation: ',hHerr_temp_violation[1], ' amount AQ violation: ',hHerr_aq_violation[1], ' total amount of violation: ', hHerr_temp_violation[1]+hHerr_aq_violation[1])
    print('-------------')
